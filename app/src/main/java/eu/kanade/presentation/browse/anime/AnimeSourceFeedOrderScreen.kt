...
import eu.kanade.tachiyomi.ui.browse.animesource.feed.AnimeSourceFeedState
...
@Composable
fun AnimeSourceFeedOrderScreen(
    state: AnimeSourceFeedState,
    onClickDelete: (AnimeFeedSavedSearch) -> Unit,
    onChangeOrder: (AnimeFeedSavedSearch, Int) -> Unit,
