...
object PlayerSettingsPlayerScreen : SearchableSettings {
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOfNotNull(
            ...
            Preference.PreferenceItem.SwitchPreference(
                ...
                title = stringResource(MR.strings.player_pref_switch_on_failure),
            ),
    ...
    private fun getDisplayGroup(playerPreferences: PlayerPreferences): Preference.PreferenceGroup {
        ...
        val panelOpacitypreference = playerPreferences.panelOpacity()
        val panelOpacity by panelOpacitypreference.collectAsState()
    ...
    private fun getTorrentServerGroup(
        ...
        val trackerspreference = torrentServerPreferences.trackers()
        val trackers by trackerspreference.collectAsState()
        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = persistentListOf(
                ...
                Preference.PreferenceItem.TextPreference(
                    ...
                    enabled = remember(trackers) { trackers != trackerspreference.defaultValue() },
                    onClick = {
                        trackerspreference.delete()
