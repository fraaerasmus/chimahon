...
/**
 * Parallel helpers matching extensions-lib (eu.kanade.tachiyomi.util stubs).
 * Extensions link against these; they must exist at runtime with identical signatures.
 */
