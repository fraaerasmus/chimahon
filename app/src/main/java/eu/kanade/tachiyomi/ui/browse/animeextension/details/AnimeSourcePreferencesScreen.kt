        ...
        Scaffold(
            ...
            Column(
                ...
                FragmentContainer(
                    ...
                    add(it, AnimeSourcePreferencesFragment.getInstance(sourceId), null)
                }
            }
        }
    }
...
class AnimeSourcePreferencesFragment : PreferenceFragmentCompat() {
    ...
    companion object {
        ...
        fun getInstance(sourceId: Long): AnimeSourcePreferencesFragment {
            return AnimeSourcePreferencesFragment().apply {
